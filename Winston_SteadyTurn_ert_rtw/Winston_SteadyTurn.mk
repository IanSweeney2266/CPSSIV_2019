###########################################################################
## Makefile generated for Simulink model 'Winston_SteadyTurn'. 
## 
## Makefile     : Winston_SteadyTurn.mk
## Generated on : Tue Feb 19 16:46:55 2019
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Winston_SteadyTurn.elf
...
PRODUCT_NAME              = Winston_SteadyTurn
MAKEFILE                  = Winston_SteadyTurn.mk
COMPUTER                  = GLNX
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Winston_SteadyTurn.elf
...
DEFINES_ = -DMODEL=Winston_SteadyTurn -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX -DON_TARGET_WAIT_FOR_START=1 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=1 -DEXT_MODE=1 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DARM_PROJECT -D_USE_TARGET_UDP_ -D_RUNONTARGETHARDWARE_BUILD_ -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
DEFINES_STANDARD = -DMODEL=Winston_SteadyTurn -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
SRCS = $(MATLAB_WORKSPACE)/Users/Iansweeney/Documents/MATLAB/SupportPackages/R2018b/toolbox/target/supportpackages/raspberrypi/src/MW_SPI.c $(START_DIR)/Winston_SteadyTurn_ert_rtw/Winston_SteadyTurn.c $(START_DIR)/Winston_SteadyTurn_ert_rtw/Winston_SteadyTurn_data.c $(START_DIR)/Winston_SteadyTurn_ert_rtw/rtGetInf.c $(START_DIR)/Winston_SteadyTurn_ert_rtw/rtGetNaN.c $(START_DIR)/Winston_SteadyTurn_ert_rtw/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_WORKSPACE)/Users/Iansweeney/Documents/MATLAB/SupportPackages/R2018b/toolbox/realtime/targets/raspi/server/MW_raspi_init.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/rtw/c/src/rtiostream/rtiostreamtcpip/rtiostream_tcpip.c

MAIN_SRC = $(START_DIR)/Winston_SteadyTurn_ert_rtw/ert_main.c
...
OBJS = MW_SPI.c.o Winston_SteadyTurn.c.o Winston_SteadyTurn_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o MW_raspi_init.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
%.c.o : $(START_DIR)/Winston_SteadyTurn_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/Winston_SteadyTurn_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/Winston_SteadyTurn_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
