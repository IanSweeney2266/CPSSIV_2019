...
// Encoder (jackknife angle)
#define ENC_PIN_1 7
#define ENC_PIN_2 8
Encoder jackknife_enc(ENC_PIN_1, ENC_PIN_2);
...
int16_t init_jackknife(int pos = 0) {
  jackknife_enc.write(pos);
}

int16_t read_jackknife() {
  return jackknife_enc.read();
}
